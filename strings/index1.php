<?php
$wambua_corrupted_file = "N3AmE,JO9b TitlE32s,Department,Full or= Pa+rt-Time,Salary or Hourly,Typi4>/>cal Hours,Annual Sal>ary,Hou)(rly Rate
...
";
$explodeArray = explode(",", $wambua_corrupted_file);
